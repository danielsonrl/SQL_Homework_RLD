#Use the sakila database for homework.
USE sakila; 
...
#Add in your column description for blob.
ALTER TABLE actor
...
JOIN country ON (cty.country_id = country.country_id)
...
SELECT f.title, COUNT(rental_id) AS 'Number_of_Rented_Movies'
FROM rental r
